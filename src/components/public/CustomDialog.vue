  ...
  <div id="custom-dialog">
     <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button v-if="button2" size="mini" type="primary" @click="clickBtn2()" :disabled="button2.disabled">{{button2.title}}</el-button>
...
<script>
export default {
  props: ['title', 'width', 'button1', 'button2', 'button3', 'button4', 'showClose', 'customClass'],
  data () {
    return {
      dialogVisible: false,
      data: null,
